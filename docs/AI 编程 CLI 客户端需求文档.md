...
> **实现更新：**
> - 2026-06-27：项目主干已实现（配对、中继、状态同步），文档定位不变，补充实现进度
> - 2026-06-28：session 筛选/切换/新建、双端消息同步、session title 命名、Mock 模式移除、侧边栏折叠、Geist 设计系统主题
> - 2026-06-28（v2）：双 Provider 架构（Codex CLI / Claude Code），AgentRuntime 基类统一管理
